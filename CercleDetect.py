...
def CercleDetection(img1):
    ...
    edge_detected_image = cv2.Canny(bilateral_filtered_image, 70, 150)
    ...
    for contour in contours:
        ...
        if ((len(approx) > 8) & (len(approx) < 23) & (area > 50000) ):
            ...
            if M["m00"] != 0:
             ...
             cX, cY = 0, 0
             ctypes.windll.user32.MessageBoxW(0, "No Piece Found", "Alert", 1)
...
cX1,cY1 = CercleDetection('Scene.jpg')
print('cX = %.3f , cY =%.3f'%(cX1,cY1))
